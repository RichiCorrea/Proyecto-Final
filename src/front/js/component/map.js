const initMap = () => {
  ...
  directionService.route(request, (result, status) => {
    if (status == google.maps.DirectionsStatus.Ok) {
      ...
      output.innerHTML = "<div className='alert-info' Desde: " + document.getElementById("from").value +  ".<br />Hacia: " + document.getElementById("to").value + ". <br /> Distancia de Manejo: " + result.routes[0].legs[0].distance.text + ".<br />Duracion: " + result.routes[0].legs[0].duration.text + ". </div>";
    ...
    <div className="jumbotron">
      <div className="container-fluid">
        ...
        <form className="form-horizontal">
          ...
          <div className="form-group">
            <div className="col-xs-4">
              <input type="text" id="to" placeholder="destiny"></input>
            </div>
          </div>
          <div className="container-fluid">
